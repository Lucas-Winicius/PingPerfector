...
export function pass(pass: string): string | null {
  ...
  if (
    ...
    return "Password too weak, please try another one with at least 8 characters and containing at least 2 lowercase letters, 2 uppercase letters and 2 numbers.";
  }
